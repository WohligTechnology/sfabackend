...
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editstudentsubmit1");?>' enctype= 'multipart/form-data'>
      ...
      <div class=" form-group">
				  ...
				  <div class="col-sm-4">
					<?php
						...
						echo form_dropdown('isverified',$isverified,set_value('isverified',$before->isverified),'class="chzn-select form-control" 	data-placeholder="Choose a Logintype..."');
					?>
				  </div>
				</div>
<div class="form-group">
...
<a href='<?php echo site_url("site/viewstudent1"); ?>' class='btn btn-secondary'>Cancel</a>
</div>
</div>
</form>
</div>
