...
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/editsportsgalleryitemsubmit");?>' enctype= 'multipart/form-data'>
...
<a href='<?php echo site_url("site/viewsportsgalleryitem?sports=".$before->sports."&sportscategory=".$before->sportscategory."&year=".$before->year); ?>' class='btn btn-secondary'>Cancel</a>
</div>
</div>
</form>
</div>
