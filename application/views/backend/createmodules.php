...
<form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createmodulessubmit");?>' enctype= 'multipart/form-data'>
<div class="panel-body">
...
<a href="<?php echo site_url("site/viewmodules"); ?>" class="btn btn-secondary">Cancel</a>
</div>
</div>
</form>
</div>
