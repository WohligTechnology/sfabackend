...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.name + "</td><td>" + resultrow.school + "</td><td>" + resultrow.email + "</td><td>" + image + "</td><td>" + resultrow.location + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editstudent1?id=');?>"+resultrow.studentid+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' onclick=\"return confirm('Are you sure you want to delete?');\" href='<?php echo site_url('site/deletestudent1?id='); ?>"+resultrow.studentid+"'><i class='icon-trash '></i></a></td></tr>";
}
